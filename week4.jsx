...
const MultiFractalArt = () => {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      new window.p5((p) => {
        ...
        // Pattern 3: Branch fractal (tree-like)
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div ref={canvasRef} className="rounded-lg shadow-2xl"></div>
    </div>
  );
};
